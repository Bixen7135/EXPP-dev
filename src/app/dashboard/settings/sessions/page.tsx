            ...
            <div className="mt-[20px] rounded-[12px] border border-slate-700/80 bg-slate-900/60 px-[24px] py-[22px]">
              <div className="flex flex-col gap-[24px] lg:flex-row lg:items-center lg:justify-between">
                <div className="flex items-start gap-[22px]">
                  ...
                  <div className="min-w-0">
                    <p className="truncate text-[18px] font-semibold leading-none text-slate-400">
                      Astana 95.57.56.126
                    </p>
                    <p className="flex items-center gap-[8px] pt-[12px] text-[14px] leading-none text-slate-300">
                      <span className="inline-block h-[10px] w-[10px] rounded-full bg-green-500" />
                      active
                    </p>
                    <p className="pt-[10px] text-[15px] leading-none text-slate-300">Your current session</p>
                    <p className="pt-[10px] text-[15px] leading-none text-slate-400">Seen in KZ</p>
                  </div>
                </div>
